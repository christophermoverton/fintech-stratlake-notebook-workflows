...
|---|---|---|---|---|---|
| Notebook 01 - extraction / daily bars backfill | extraction/backfill | `fintech-market-ingestion` | `imported_pending_validation` | `notebook_cleaned_outputs_cleared` | Cleaned candidate: [notebooks/01_fintech_daily_bars_extraction_backfill.ipynb](../notebooks/01_fintech_daily_bars_extraction_backfill.ipynb). Staging/classification recorded in [Notebook 01 staging and classification](notebook_01_staging_classification.md). Audit and manual Colab smoke remain pending. |
