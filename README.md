...
Notebook 00 through Notebook 08 are imported and tracked in the notebook index. Notebook 09 and later remain planned until they go through the same staged, cleaned, validated, and audited import workflow.
...
- Notebook 08 - single-strategy backtest and artifact review (imported; source-only validated; Colab smoke pending M11.6)
