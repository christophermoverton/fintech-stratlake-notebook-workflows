...
Notebook 00 through Notebook 13 are imported and tracked in the notebook index. Notebook 14 and later remain planned until they go through the same staged, cleaned, validated, and audited import workflow.
...
- Notebook 13 - native campaign execution and artifact generation (imported; source-only validated; manual runtime smoke context recorded outside Git with no readiness claims)
